...
const Preloader = ({ onFinished }) => {
  ...
  const fullText = "www.FikriAlifaAlfaRamadhan.com";
        ...
        >
          ...
          {showContent && (
            ...
            >
              ...
              >
                <a href="https://github.com/alzri213" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Github size={32} />
                </a>
                <a href="https://www.youtube.com/@AlzriGamesYT" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Youtube size={32} />
                </a>
                <a href="https://www.instagram.com/zreekx" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Instagram size={32} />
                </a>
              </motion.div>
            </motion.div>
